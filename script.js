...
// click 
document.addEventListener("DOMContentLoaded", () => {
    const btn = document.getElementById("projectBtn1");
    btn.addEventListener("click", () => {
        // Redirect to project details page
        const projectlink = "Siddarthasubedi.jpg";
        window.open(projectlink, "_blank");
    });
});

document.addEventListener("DOMContentLoaded", () => {
    const btn = document.getElementById("projectBtn2");
    btn.addEventListener("click", () => {
        // Redirect to project details page
        const projectlink = "quiz game\Program.cs";
        window.open(projectlink, "_blank");
    });
});

document.addEventListener("DOMContentLoaded", () => {
    const btn = document.getElementById("projectBtn3");
    btn.addEventListener("click", () => {
        // Redirect to project details page
        const projectlink = "amazon";
        window.open(projectlink, "_blank");
    });
});